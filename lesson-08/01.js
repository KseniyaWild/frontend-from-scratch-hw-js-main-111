/*
  ...
  🧙 Подсказка: если пользователь кликнет по кнопке с питомцев, id питомца можно будет получить из объекта события(элемент на котором сработал обработчик) (event.target.id)
*/
